...
#
echo "*"                                                              >figura.gs
echo "* esse script é auto gerado. documentação em adquire_eta.sh"   >>figura.gs
echo "* By reginaldo.venturadesa@gmail.com   "                       >>figura.gs
echo "'open modelo_all.ctl'"                                         >>figura.gs
echo "'set parea 0.5 8.5 1.5 10.2'"                                  >>figura.gs
echo "'set lon -75 -30'"                                             >>figura.gs
echo "'set lat -35  10'"                                             >>figura.gs
echo "'set mpdset hires'"                                            >>figura.gs
echo "'../../cores.gs'"                                              >>figura.gs
echo "'set gxout shaded'"                                            >>figura.gs
echo "'d sum(prec,t=2,t=8)'"                                         >>figura.gs
echo "'draw string 0.5 10.8 PRECIPITACAO ACUMULADA 7 DIAS '"  >>figura.gs
echo "'draw string 0.5 10.6 RODADA :"$DATA0" - "$hora"Z'"     >>figura.gs
echo "'draw string 0.5 10.4 Periodo:"$DATA2" a "$DATA1"'"     >>figura.gs
...
#
echo "*"                                                              >figura2.gs
echo "* esse script é auto gerado. documentação em adquire_eta.sh"   >>figura2.gs
echo "*By reginaldo.venturadesa@gmail.com "                           >>figura2.gs
echo "'open modelo_all.ctl'"                     >figura2.gs
echo "'set parea off'"                     >>figura2.gs
echo "'set parea 0.5 8.5 1.5 10.0'"                                  >>figura2.gs
echo "'set lon -75 -30'"                                  >>figura2.gs
echo "'set lat -35  10'"                                  >>figura2.gs
echo "'set mpdset hires'"                       >>figura2.gs
echo "'set gxout shaded'"                       >>figura2.gs
echo "'set string 1 c'"                       >>figura2.gs
#
# acha a data que tem o sabado que é o marco
# para a semana operativa
#
...
echo "'draw string 2.5 10.8 PRECIPITACAO ACUMULADA SEMANA OPERATIVA 1 '"  >>figura2.gs
echo "'draw string 1.5 10.6 RODADA:"$DATA0" - "$hora"Z'"                >>figura2.gs
echo "'draw string 2.2 10.4 PERIODO:'var1' a 'var2"                     >>figura2.gs                                            
echo "'../../plota.gs'"                                                   >>figura2.gs
echo "'printim semanaoperativa_1_"$data".png white'"                       >>figura2.gs
#
# plota semana operativa 2
#
echo "'c'"                                                             >>figura2.gs
echo "'../../cores.gs'"                    >>figura2.gs
echo "'d sum(prec,t='t0',t=10)'"         >>figura2.gs
echo "'cbarn.gs'"                       >>figura2.gs
echo "'draw string 2.5 10.8 PRECIPITACAO ACUMULADA SEMANA OPERATIVA 2 '"  >>figura2.gs
echo "'draw string 1.5 10.6 RODADA:"$DATA0" - "$hora"Z'"                >>figura2.gs
echo "'draw string 2.2 10.4 PERIODO:'var2' a 'var3"                     >>figura2.gs
echo "'../../plota.gs'"                                                   >>figura2.gs
...
echo "["`date`"] PLOTANDO FIGURAS 7 DIAS BRASIL" 

grads -pbc "figura.gs"  >>./LOG.prn 2>&1
echo "["`date`"] PLOTANDO FIGURAS SEMANA OPERATIVA BRASIL" 
